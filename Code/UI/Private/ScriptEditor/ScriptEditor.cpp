...
void ScriptEditor::doOpen(const std::string& path)
{
...
void ScriptEditor::saveAs(const std::string& path)
{
...
void ScriptEditor::renderSaveAsPopup()
{
...
void ScriptEditor::renderUnsavedPopup()
{
...
static void acceptFileDropTarget(ScriptEditor& editor, const ImVec2& min, const ImVec2& max)
{
