...
export namespace Procedural
{
	...
	// steep faces toward bare Rock. Pure and deterministic.
	EBiome classifyBiome(float temperature, float humidity, float altitude, float seaLevel, float slope01 = 0.0f);
