...
{
	VRHandTrackingComponent& createHandTrackingComponentRig(entt::registry& registry, entt::entity entity, GraphicsSystem& graphics, PhysicsSystem& physics, const HandSkeletonData& handData)
	{
	...
	entt::entity createLeftHand(entt::registry& registry, GraphicsSystem& graphics, PhysicsSystem& physics, SceneSystem& scene, const HandSkeletonData& handData)
	{
		...
		auto& handComponent = createHandTrackingComponentRig(registry, entity, graphics, physics, handData);
		return entity;
	}
