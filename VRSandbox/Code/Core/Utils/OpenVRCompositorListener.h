...
protected:
    ...
    Ogre::Matrix4           m_devicePose[vr::k_unMaxTrackedDeviceCount];
    vr::ETextureType        m_apiTextureType;
    Ogre::VrData            m_vrData;
    Ogre::Camera* m_pCamera;
    Ogre::Camera* m_pVrCullCamera;
    Ogre::Vector3           m_cullCameraOffset;

    Ogre::Matrix4 m_leftControllerPosition;
    Ogre::Matrix4 m_rightControllerPosition;

    VrWaitingMode::VrWaitingMode m_waitingMode;
    VrWaitingMode::VrWaitingMode m_firstGlitchFreeMode;
    Ogre::Real              m_lastCamNear;
    Ogre::Real              m_lastCamFar;
    bool                    m_mustSyncAtEndOfFrame;
    Ogre::SceneNode* m_pControllerNode;
...
public:
    OpenVRCompositorListener(vr::IVRSystem* hmd, vr::IVRCompositor* vrCompositor,
        Ogre::TextureGpu* vrTexture, Ogre::Root* root, Ogre::CompositorWorkspace* workspace,
        Ogre::Camera* camera, Ogre::Camera* cullCamera, Ogre::SceneNode* pControllerNode);
    ...
    const Ogre::Matrix4& getLeftControllerPosition() const { return m_leftControllerPosition; }
    const Ogre::Matrix4& getRightControllerPosition() const { return m_rightControllerPosition; }

    /// See VrWaitingMode::VrWaitingMode
    void setWaitingMode(VrWaitingMode::VrWaitingMode waitingMode);
    VrWaitingMode::VrWaitingMode getWaitingMode(void) { return m_waitingMode; }
